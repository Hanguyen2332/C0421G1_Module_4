...
//        mav.addObject("blogList", iBlogService.findByTitleIsContaining(blogOjb.getTitle()));
//        mav.addObject("blogList", iBlogService.findByTitleContains(blogOjb.getTitle()));
//        mav.addObject("blogList", iBlogService.findByTitleLike(blogOjb.getTitle()));
